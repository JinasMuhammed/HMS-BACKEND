...
module.exports.addUser = function (
  ...
  console.log("Email Status:", email_status);
  ...
  // Form the SQL query
  var query =
    "INSERT INTO `users`(`username`, `email`, `password`, `email_status`, `role`, `firstName`, `lastName`) VALUES ('" +
    username +
    "','" +
    email +
    "','" +
  ...
  // For debugging purposes, output the final query
